  ...
  return (
    <group rotation={[0, 0, Math.PI / 4]}>
      <Points ref={ref} positions={sphere} stride={3} frustumCulled={false}>
        <PointMaterial transparent color="#9333EA" size={0.05} sizeAttenuation depthWrite={false} blending={THREE.AdditiveBlending} />
      </Points>
      <Points positions={sphere.map(v => v * 1.1)} stride={3} frustumCulled={false}>
        <PointMaterial transparent color="#3B82F6" size={0.03} sizeAttenuation depthWrite={false} blending={THREE.AdditiveBlending} />
      </Points>
    </group>
  );
}
        ...
        <div className="relative z-10 text-center px-12">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            <div className="flex justify-center mb-8">
              <motion.div
                animate={{ boxShadow: ["0 0 20px rgba(147,51,234,0.3)","0 0 40px rgba(168,85,247,0.6)","0 0 20px rgba(147,51,234,0.3)"], scale: [1,1.05,1] }}
            ...
            <h1 className="text-5xl font-bold tracking-tight mb-4 bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">Admin Portal</h1>
            <p className="text-xl text-slate-400 max-w-md mx-auto">Secure Administrative Management</p>
          </motion.div>
        </div>
      </div>
          ...
          <div className="max-w-md w-full mx-auto">
            ...
            >
              <div className="flex flex-col items-center lg:items-start mb-10">
                ...
                <p className="text-slate-400 text-sm sm:text-base text-center lg:text-left max-w-[280px] sm:max-w-none">
                  Enter your credentials to access the TAMx Admin Dashboard.
                </p>
              </div>
