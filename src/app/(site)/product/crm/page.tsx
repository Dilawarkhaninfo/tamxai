...
import { ArrowLeft, Send, Sparkles, LayoutGrid, Users, BarChart3, Database } from 'lucide-react'
    ...
    <main className="relative min-h-screen w-full overflow-hidden bg-[#020202] text-foreground flex flex-col items-center justify-center selection:bg-brand-purple/30 selection:text-white">
      ...
      <div className="relative z-10 w-full max-w-5xl px-6 py-20 flex flex-col items-center text-center">
        ...
        <div className="relative mb-8">
          ...
          >
            <LayoutGrid className="w-10 h-10 text-brand-purple" />
          </motion.div>
          ...
          >
            <Users className="w-5 h-5 text-brand-lavender" />
          </motion.div>
        ...
        >
          ...
          <p className="text-foreground/60 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed mb-12">
            The future of customer relationship management is being engineered. 
            A robust, intelligent ecosystem designed to synchronize your sales, marketing, and support into a single source of truth.
          </p>
        </motion.div>
        ...
        >
          {[
            { icon: Users, title: "360° View", desc: "Holistic customer lifecycle tracking" },
            { icon: Sparkles, title: "Smart Automation", desc: "AI-driven lead scoring & tasks" },
            { icon: Database, title: "Unified Data", desc: "Seamless cross-platform integration" }
          ].map((feature, i) => (
