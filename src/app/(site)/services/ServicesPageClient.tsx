...
import { Layout, Code2, Rocket, Brain, Stethoscope, Cpu, Search, PencilRuler, PlayCircle, BarChart3, ChevronLeft, ChevronRight, type LucideIcon } from 'lucide-react';
...
const servicesImages = [
  ...
  'https://images.unsplash.com/photo-1518186239751-2467ef758332?q=80&w=2072&auto=format&fit=crop',
  'https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?q=80&w=2070&auto=format&fit=crop',
];

const FALLBACK_ICON_MAP: Record<string, LucideIcon> = {
  Layout, Code2, Rocket, Brain, Stethoscope, Cpu,
};
...
export default function ServicesPageClient({ services: dbServices }: ServicesPageClientProps) {
  const expandedServices = dbServices && dbServices.length > 0
